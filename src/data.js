...
export const radioList = [
  {
    ...
    logo: `${logoFLASH}`,
    // audio: `${audioFLASH}`,
    audio: 'https://vincentbonhomme.io/wp-content/uploads/2021/08/flash-fm-gta-vice-city.mp3',
    path: '/',
    background: '#EE4E8C',
    weapon: `${weaponFLASH}`
  },
  {
    ...
    logo: `${logoWAVE}`,
    // audio: `${audioWAVE}`,
    audio: 'https://vincentbonhomme.io/wp-content/uploads/2021/08/wave-103-grand-theft-auto-vice-city.mp3',
    path: '/wave',
    background: '#AF95B8',
    weapon: `${weaponWAVE}`
  },
  {
    ...
    audio: 'https://vincentbonhomme.io/wp-content/uploads/2021/08/wildstyle-gta-vice-city-radio-full-hq.mp3',
    path: '/wildstyle',
    background: '#CCC5C2',
  ...
  },
  {
    ...
    logo: `${logoFEVER}`,
    // audio: `${audioFEVER}`,
    audio: 'https://vincentbonhomme.io/wp-content/uploads/2021/08/fever-105-grand-theft-auto-vice-city.mp3',
    path: '/fever',
    background: '#D6607A',
    weapon: `${weaponFEVER}`
  },
  {
    ...
    audio: 'https://vincentbonhomme.io/wp-content/uploads/2021/08/radio-espantoso-grand-theft-auto-vice-city-vice-city-stories.mp3',
    path: '/espantoso',
    background: '#F78921',
  ...
  },
  {
    ...
    logo: `${logoEMOTION}`,
    // audio: `${audioEMOTION}`,
    audio: 'https://vincentbonhomme.io/wp-content/uploads/2021/08/emotion-983-gta-vice-city-stories-gta-vice-city-hosted-by-fernando-martinez.mp3',
    path: '/emotion',
    background:'#758DC6',
  ...
  },
  {
    ...
    logo: `${logoVCPR}`,
    // audio: `${audioVROCK}`,
    audio: 'https://vincentbonhomme.io/wp-content/uploads/2021/08/gta-vice-city-radio-comedy-vcpr.mp3',
    path: '/vcpr',
    background: '#4686C9',
    weapon: `${weaponVCPR}`
  },
  {
    ...
    logo: `${logoKCHAT}`,
    // audio: `${audioKCHAT}`,
    audio: 'https://vincentbonhomme.io/wp-content/uploads/2021/08/grand-theft-auto-vice-city-k-chat-pc.mp3',
    path: '/kchat',
    background: '#A0B2DB',
    weapon: `${weaponKCHAT}`
  },
